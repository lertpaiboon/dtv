...
const faqs = [
  ...
  },
  {
    ...
    a: 'ค่าทำบัญชีเริ่มต้น 1,000 บาทต่อเดือน ราคาจะขึ้นอยู่กับประเภทธุรกิจ ปริมาณเอกสาร จำนวนรายการ และความซับซ้อนของภาษี เราจะสอบถามข้อมูลและแจ้งราคาที่ชัดเจนให้ทราบก่อนเริ่มงาน',
  },
  {
  ...
  },
  {
    ...
    a: 'สำนักงานอยู่ที่ 234/116 ถนนอโศก–ดินแดง แขวงบางกะปิ เขตห้วยขวาง กรุงเทพฯ 10310 ใกล้ MRT เพชรบุรี ทางออก 1 เปิดวันจันทร์ถึงเสาร์ เวลา 08:30–18:00 น. แนะนำให้นัดหมายก่อนเข้าพบ',
  },
  {
